...
// A lista de categorias que você nos deu
const categories = [
  "cirurgia geral",
  "cirurgia do trauma",
  "cirurgia oncológica",
      ...
      <section>
        ...
        <ul style={{ listStyle: 'none', padding: 0, display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '1rem' }}>
          {categories.map((category) => {
            // Transforma o nome da categoria em um formato para URL
            // ex: "cirurgia plástica" -> "cirurgia-plastica"
            ...
            return (
              <li key={categorySlug}>
                <Link 
                  ...
                  onMouseOver={e => { e.currentTarget.style.borderColor = '#0070f3'; e.currentTarget.style.boxShadow = '0 4px 14px 0 rgba(0, 118, 255, 0.1)'; }}
